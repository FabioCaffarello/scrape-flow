...
INSERT INTO "new_ExecutionPhase" ("completedAT", "id", "inputs", "name", "node", "number", "outputs", "startedAt", "status", "workflowExecutionId") SELECT "completedAT", "id", "inputs", "name", "node", "number", "outputs", "startedAt", "status", "workflowExecutionId" FROM "ExecutionPhase";
