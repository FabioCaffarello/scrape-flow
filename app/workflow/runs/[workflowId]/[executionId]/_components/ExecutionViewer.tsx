        ...
        {isRunning && (
          <div className="flex items-center flex-col gap-2 justify-center h-full w-full">
            <p className="font-bold">
              Run is still in progress... please wait.
            </p>
          </div>
        )}
          ...
          <div className="flex items-center flex-col gap-2 justify-center h-full w-full">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Select a phase to see its details.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col gap-2">
          {!params ||
            (Object.keys(params).length === 0 && (
              <p className="text-sm">No parameters generated by this fase</p>
            ))}
          {params &&
          ...
          <TableBody>
            {logs.map((log) => (
              <TableRow key={log.id} className="text-muted-foreground">
                <TableCell
                  width={190}
                  className="text-xs text-muted-foreground p-[2px] p1-4"
                >
