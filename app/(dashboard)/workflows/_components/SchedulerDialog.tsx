...
import { RemoveWorkflowSchedule } from "@/actions/workflows/remodeWorkflowSchedule";
            ...
            <DialogClose asChild>
              <div className="">
                <Button
                  ...
                  onClick={() => {
                    toast.loading("Removing workflow schedule...", {
                      id: "cron",
                    });
        ...
        <DialogFooter className="px-6 gap-2">
          ...
          <DialogClose asChild>
            <Button
              ...
              onClick={() => {
                toast.loading("Saving workflow schedule...", { id: "cron" });
                mutation.mutate({
                  id: props.WorkflowId,
                  cron,
                });
